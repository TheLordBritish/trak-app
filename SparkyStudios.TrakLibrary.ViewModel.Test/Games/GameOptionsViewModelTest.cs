...
namespace SparkyStudios.TrakLibrary.ViewModel.Test.Games
{
    public class GameOptionsViewModelTest
    {
        ...
        public void UpdateGameCommand_WithNonExistentEntry_DoesntUpdateEntry()
        {
            ...
            // Assert
            _restService.Verify(
                mock => mock.PutAsync(It.IsAny<string>(), It.IsAny<GameUserEntry>()), Times.Never);
        ...
        public void UpdateGameCommand_WithExistingEntry_UpdatesEntry()
        {
            ...
            // Assert
            _restService.Verify(
                mock => mock.PutAsync(It.IsAny<string>(), It.IsAny<GameUserEntry>()), Times.Once);
            _navigationService.Verify(mock => mock.GoBackAsync(), Times.Once);
        ...
        public void DeleteGameCommand_WithNonExistentEntry_DoesntDeleteEntry()
        {
            ...
            // Assert
            _restService.Verify(mock => mock.DeleteAsync(It.IsAny<string>()), Times.Never);
            _navigationService.Verify(mock => mock.GoBackAsync(), Times.Once);
        }
