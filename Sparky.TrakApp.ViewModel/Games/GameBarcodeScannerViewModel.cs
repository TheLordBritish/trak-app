...
namespace Sparky.TrakApp.ViewModel.Games
{
    ...
    /// </summary>
    public class GameBarcodeScannerViewModel : BaseViewModel
    {
        ...
        /// </summary>
        public ICommand ScanCommand => new DelegateCommand(async () => await ScanAsync(), () => !IsBusy)
        ...
        ///     <see cref="AttemptBarcodeScanAsync" />
        ///     throws a <see cref="ApiException" />. This method will check the status code of the thrown
        ///     <see cref="ApiException" />,
        ///     if the status code is a 404, then the user will be prompted to make a request for the game to be added to the game
        ...
        private void HandleApiException(ApiException e)
        {
            ...
            if (e.StatusCode == HttpStatusCode.NotFound)
            {
                ...
                _formsDevice.BeginInvokeOnMainThread(async () =>
                {
                    await _userDialogs.PromptAsync(promptConfig);
                    // TODO: Get the result and navigate to the game request page.
                });
            }
            else
            {
                ...
                _formsDevice.BeginInvokeOnMainThread(async () => await _userDialogs.AlertAsync(alertConfig));
            }
        }
