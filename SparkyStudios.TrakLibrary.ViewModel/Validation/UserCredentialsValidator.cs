...
namespace SparkyStudios.TrakLibrary.ViewModel.Validation
{
    ...
    /// within the <see cref="LoginRequest"/> class to ensure that they can valid information before
    /// being passed onto an API call.
    /// </summary>
    public class UserCredentialsValidator : AbstractValidator<LoginRequest>
    {
